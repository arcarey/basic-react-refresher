...
describe('StoryDetail', () => {
  ...
  it('should be true', () => {
    ...
    // it('should create', () => {
    //     const { getElementsByClassName } = render(<Story-Detail></Story-Detail>);
    //     const spy = jest.spyOn(fetchStories, 'stories')
    //     spy.mockEndpointResponse(mockEndpointResponse)
    //     expect(getElementsByClassName('story-detail-title')).toBe('Pardoned for Serving in Ukraine, They Return to Russia to Kill Again')
    // })
})